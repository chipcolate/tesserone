...
extension Color {
    ...
    /// Widget chrome background, following the system appearance (matches the
    /// app's Raw-Aesthetic bg: #FAFAF8 light / #0A0A0A dark).
    static func widgetBackground(_ scheme: ColorScheme) -> Color {
        scheme == .dark
