...
A loyalty card manager that feels alive. Cards aren't rows in a database — they're objects you hold, flip, and fan through. Built with Apple Wallet-style interactions, spring physics, and haptic feedback.

Local-first. Zero cloud. Zero bloat. Open source.

## Features

- **Apple Wallet card stack** — scroll, tap to expand, swipe up to dismiss
  ...
  "cards": [
    {
      ...
      "name": "IKEA",
      "code": "https://ikea.com/loyalty/1234567",
      "format": "QR",
      "color": "#1456A2",
      "logoSlug": "ikea",
      "notes": "Family card",
