...
const BUNDLED_LOGOS: Record<string, ImageSourcePropType> = {
  ...
  'burger-king.png': require('../../assets/logos/burger-king.png'),
  'h-and-m.png': require('../../assets/logos/h-and-m.png'),
  'kfc.png': require('../../assets/logos/kfc.png'),
  'mcdonalds.png': require('../../assets/logos/mcdonalds.png'),
  'adidas.png': require('../../assets/logos/adidas.png'),
  'foot-locker.png': require('../../assets/logos/foot-locker.png'),
  'nike.png': require('../../assets/logos/nike.png'),
  'starbucks.png': require('../../assets/logos/starbucks.png'),
  'subway.png': require('../../assets/logos/subway.png'),
  'dominos.png': require('../../assets/logos/dominos.png'),
  'intersport.png': require('../../assets/logos/intersport.png'),
  'pizza-hut.png': require('../../assets/logos/pizza-hut.png'),
  'zooplus.png': require('../../assets/logos/zooplus.png'),
  'conforama.png': require('../../assets/logos/conforama.png'),
  'douglas.png': require('../../assets/logos/douglas.png'),
  'five-guys.png': require('../../assets/logos/five-guys.png'),
  'jd-sports.png': require('../../assets/logos/jd-sports.png'),
  'marionnaud.png': require('../../assets/logos/marionnaud.png'),
  'rituals.png': require('../../assets/logos/rituals.png'),
  'samsung.png': require('../../assets/logos/samsung.png'),
  'spar.png': require('../../assets/logos/spar.png'),
  'the-body-shop.png': require('../../assets/logos/the-body-shop.png'),
  'tim-hortons.png': require('../../assets/logos/tim-hortons.png'),
  'apple.png': require('../../assets/logos/apple.png'),
  'bauhaus.png': require('../../assets/logos/bauhaus.png'),
  'c-and-a.png': require('../../assets/logos/c-and-a.png'),
  'calzedonia.png': require('../../assets/logos/calzedonia.png'),
  'chicco.png': require('../../assets/logos/chicco.png'),
  'co-op.png': require('../../assets/logos/co-op.png'),
  'dunkin.png': require('../../assets/logos/dunkin.png'),
  'expert.png': require('../../assets/logos/expert.png'),
  'famila.png': require('../../assets/logos/famila.png'),
  'game.png': require('../../assets/logos/game.png'),
  'gamestop.png': require('../../assets/logos/gamestop.png'),
  'gap.png': require('../../assets/logos/gap.png'),
  'intimissimi.png': require('../../assets/logos/intimissimi.png'),
  'kiko-milano.png': require('../../assets/logos/kiko-milano.png'),
  'krispy-kreme.png': require('../../assets/logos/krispy-kreme.png'),
  'loccitane.png': require('../../assets/logos/loccitane.png'),
  'lego-store.png': require('../../assets/logos/lego-store.png'),
  'maisons-du-monde.png': require('../../assets/logos/maisons-du-monde.png'),
  'popeyes.png': require('../../assets/logos/popeyes.png'),
  'prenatal.png': require('../../assets/logos/prenatal.png'),
  'sport-2000.png': require('../../assets/logos/sport-2000.png'),
  'taco-bell.png': require('../../assets/logos/taco-bell.png'),
  'tezenis.png': require('../../assets/logos/tezenis.png'),
  ...
  'alcott.png': require('../../assets/logos/alcott.png'),
  'bricocenter.png': require('../../assets/logos/bricocenter.png'),
  'bricofer.png': require('../../assets/logos/bricofer.png'),
  'chef-express.png': require('../../assets/logos/chef-express.png'),
  'despar.png': require('../../assets/logos/despar.png'),
  'dr-max.png': require('../../assets/logos/dr-max.png'),
  'eataly.png': require('../../assets/logos/eataly.png'),
  'eurobrico.png': require('../../assets/logos/eurobrico.png'),
  'fao-schwarz.png': require('../../assets/logos/fao-schwarz.png'),
  'flying-tiger-copenhagen.png': require('../../assets/logos/flying-tiger-copenhagen.png'),
  'geox.png': require('../../assets/logos/geox.png'),
  'guess.png': require('../../assets/logos/guess.png'),
  'libraccio.png': require('../../assets/logos/libraccio.png'),
  'libreriecoop.png': require('../../assets/logos/libreriecoop.png'),
  'liu-jo.png': require('../../assets/logos/liu-jo.png'),
  'piazza-italia.png': require('../../assets/logos/piazza-italia.png'),
  'pittarello.png': require('../../assets/logos/pittarello.png'),
  'rossopomodoro.png': require('../../assets/logos/rossopomodoro.png'),
  'sportler.png': require('../../assets/logos/sportler.png'),
  'todis.png': require('../../assets/logos/todis.png'),
  'tommy-hilfiger.png': require('../../assets/logos/tommy-hilfiger.png'),
  'united-colors-of-benetton.png': require('../../assets/logos/united-colors-of-benetton.png'),
  'venchi.png': require('../../assets/logos/venchi.png'),
  'xiaomi.png': require('../../assets/logos/xiaomi.png'),
  'yamamay.png': require('../../assets/logos/yamamay.png'),
};
