...
export const fr: Translations = {
  ...
  add: {
    ...
    cameraPermissionBlockedTitle: "Accès à l'appareil photo requis",
    cameraPermissionBlockedBody: "Tesserone a besoin de l'appareil photo pour scanner un code-barres. Active-le dans les Réglages.",
    photoPermissionDeniedTitle: 'Accès aux photos requis',
    photoPermissionDeniedBody: "Tesserone a besoin de l'accès aux photos pour lire un code-barres. Active-le dans les Réglages.",
    stepIndicator: 'Étape {{current}} sur {{total}}',
    stepBarcodeTitle: 'Code-barres',
    stepBarcodeSubtitle: 'Scanne, prends une photo ou saisis le code',
    stepBrandTitle: 'Enseigne',
    stepBrandSubtitle: 'Trouve ton magasin ou ajoute-le toi-même',
    stepReviewTitle: 'Vérification',
    stepReviewSubtitle: 'Vérifie tout, puis enregistre',
    methodScanTitle: 'Scanner le code',
    methodScanHint: "Utiliser l'appareil photo",
    methodPhotoTitle: 'Depuis une photo',
    methodPhotoHint: 'Choisir dans la galerie',
    methodTypeTitle: 'Saisir le code',
    methodTypeHint: 'Entrer le code à la main',
    brandSearchLabel: 'Trouve ton enseigne',
    brandSearchPlaceholder: 'Rechercher des magasins…',
    brandNoResults: 'Aucun résultat. Ajoute-le manuellement ci-dessous.',
    brandCustomTitle: 'Pas dans la liste ?',
    brandCustomHint: 'Définis toi-même un nom et un logo.',
  },
  card: {
